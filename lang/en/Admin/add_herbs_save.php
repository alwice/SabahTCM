...
<?php 
	...
	if($mode==1){
		if($m==3){/*update*/
			$sql="UPDATE herb_info SET local_name='$herb_name',  usage_part='$part', function='$function', disease='$disease' WHERE info_id='$info_id'";
			mysqli_query($conn,$sql)or die(mysqli_error($conn));
		
			$sql3="UPDATE herb_list SET local_name='$herb_name', other_name='$other_name', scientific_name='$sci_name', family='$family' WHERE herb_id='$herb_id'";
			...
			$sql="INSERT INTO herb_info (herb_id, local_name, usage_part, function, disease)
		...
		$sql2="INSERT INTO herb_list (local_name, other_name, scientific_name, family, image)
